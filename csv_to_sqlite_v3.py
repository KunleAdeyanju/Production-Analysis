...
import sqlite3
import pandas as pd
from sqlalchemy import types, create_engine # Import SQLAlchemy types

# --- CONFIG ---
csv_folder = "./data_files"           # folder containing CSV files
output_folder = "./database"     # folder to save the .db file
db_name = "production2.db"                # name of the SQLite database file
# --------------
...
for filename in os.listdir(csv_folder):
    if filename.lower().endswith(".csv"):
        ...
        # Read CSV into DataFrame, treating commas as thousands separators
        try:
        ...
        # --- (The rest of your code for date handling can remain the same) ---
...
engine.dispose() # This is how you'd close the engine's connection pool
...
#         '''
#         By adding thousands=',', you are instructing pandas: 
#         "When you are reading this file, if you see a comma within a potential number, 
#         please treat it as a thousands separator and parse the number correctly.
#         '''
#         df = pd.read_csv(csv_path, thousands=',')
